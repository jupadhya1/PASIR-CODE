...
dir="/opt/pasir-classr"
cmd="/usr/local/bin/python2.7 server.py"
#user="classrapi"

name="pasir-classr"
pid_file="/var/run/$name.pid"
stdout_log="/app/pasir-classr-data/logs/stdout.log"
stderr_log="/app/pasir-classr-data/logs/stderr.log"
